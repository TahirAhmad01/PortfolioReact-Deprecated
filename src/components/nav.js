...
export default function NavbarP() {
  ...
  return (
    <React.Fragment>
      <div
        className={`backdrop-blur-xl bg-slate-100/40 dark:bg-[#0b1327]/70 w-full top-0 left-0 fixed z-50 py-6 transition-all duration-200 border-b-2 border-inherit dark:border-gray-700 my-collapsible ${
          scrollY > 80 && "py-5"
        }`}
      >
